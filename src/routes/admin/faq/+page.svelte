...
<div>
  ...
  <div class="flex items-center justify-between mb-8">
    <div>
      ...
      <p class="text-zinc-400 text-sm mt-1">Configure individual Q&A items shown on the public landing page.</p>
    </div>
    <button
      onclick={openAdd}
  ...
  <dialog bind:this={addDialog} class="bg-zinc-900 border border-zinc-800 rounded-2xl p-6 text-zinc-100 backdrop:bg-black/60 backdrop:backdrop-blur-sm max-w-lg w-full">
    ...
    >
      <div>
        <label for="add-question" class="block text-xs font-semibold text-zinc-400 uppercase tracking-wider mb-2">Question</label>
        <input
          type="text"
          id="add-question"
          name="question"
      ...
      <div>
        <label for="add-answer" class="block text-xs font-semibold text-zinc-400 uppercase tracking-wider mb-2">Answer</label>
        <textarea
          id="add-answer"
          name="answer"
          rows="4"
      ...
      <div class="flex justify-end gap-3 pt-4 border-t border-zinc-800">
        ...
        <button type="submit" disabled={loading} class="bg-white hover:bg-zinc-200 text-zinc-950 text-sm font-semibold px-5 py-2.5 rounded-xl transition-all">{loading ? 'Saving...' : 'Add FAQ'}</button>
      </div>
    </form>
  </dialog>
  ...
  <dialog bind:this={editDialog} class="bg-zinc-900 border border-zinc-800 rounded-2xl p-6 text-zinc-100 backdrop:bg-black/60 backdrop:backdrop-blur-sm max-w-lg w-full">
    ...
    >
      ...
      <div>
        <label for="edit-question" class="block text-xs font-semibold text-zinc-400 uppercase tracking-wider mb-2">Question</label>
        <input
          type="text"
          id="edit-question"
          name="question"
      ...
      <div>
        <label for="edit-answer" class="block text-xs font-semibold text-zinc-400 uppercase tracking-wider mb-2">Answer</label>
        <textarea
          id="edit-answer"
          name="answer"
          rows="4"
