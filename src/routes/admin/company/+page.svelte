...
<div>
	...
	<div class="mb-8">
		...
		<p class="text-zinc-400 text-sm mt-1">
			Configure company profiles, contacts, and security settings.
		</p>
	</div>
	...
	<div class="flex border-b border-zinc-900 mb-8">
		<button
			...
			class="px-5 py-3 text-sm font-semibold border-b-2 transition-colors {activeTab === 'profile'
		...
		<button
			...
			class="px-5 py-3 text-sm font-semibold border-b-2 transition-colors {activeTab === 'security'
				? 'border-white text-white'
				: 'border-transparent text-zinc-400 hover:text-zinc-200'}"
		>
			Security & Password
				...
				<div class="grid grid-cols-1 md:grid-cols-2 gap-6">
					<div>
						...
						<span class="text-[10px] text-zinc-500 mt-1 block"
							>Specify the media key from the gallery upload or direct reference.</span
						>
					</div>
			...
			<div class="bg-zinc-900/10 border border-zinc-900 rounded-2xl p-6 space-y-6">
				...
				<div class="grid grid-cols-1 md:grid-cols-2 gap-6">
					...
					<div>
						...
						/>
						<span class="text-[10px] text-zinc-500 mt-1 block"
							>Country code + number, digits only — no +, spaces, or dashes. Do not start with 0.
							Example: <span class="text-zinc-400 font-mono">447911123456</span> for +44 7911 123456.</span
						>
					</div>
				</div>
				...
				<div>
					<label
						for="whatsappDefaultMessage"
						class="block text-xs font-semibold text-zinc-400 uppercase tracking-wider mb-2"
						>Default WhatsApp Message</label
					>
					<input
						type="text"
					...
					/>
					<span class="text-[10px] text-zinc-500 mt-1 block"
						>Shown when a visitor opens WhatsApp without filling out the form first. Max 200
						characters. Leave blank to use the built-in default.</span
					>
				</div>
		...
		>
			...
			<div class="bg-zinc-900/10 border border-zinc-900 rounded-2xl p-6 space-y-5">
				...
				<p class="text-xs text-zinc-500 leading-relaxed">
					Rotating your admin credentials invalidates all other active session cookies. You will
					remain logged in on this browser.
				</p>
				...
				<div>
					<label
						for="newPassword"
						class="block text-xs font-semibold text-zinc-400 uppercase tracking-wider mb-2"
						>New Password (Min 12 chars)</label
					>
					<input
						type="password"
						name="newPassword"
