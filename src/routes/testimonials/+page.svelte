...
<svelte:head>
	...
	<meta
		name="description"
		content="Read customer endorsements and client reviews describing our development speed, support quality, and design outcomes."
	/>
	...
	<div class="max-w-7xl mx-auto space-y-16">
		...
		<div class="text-center space-y-4 max-w-xl mx-auto">
			...
			<p class="text-zinc-405 text-sm leading-relaxed">
				Don't just take our word for it. Read what our clients have to say about working with our
				team.
			</p>
		</div>
		...
		{:else}
			<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
				{#each data.testimonials as item}
					<div
						class="bg-zinc-900/10 border border-zinc-900 rounded-2xl p-6 md:p-8 space-y-6 backdrop-blur flex flex-col justify-between h-full"
					>
						<div class="space-y-4">
							<!-- Rating Stars -->
