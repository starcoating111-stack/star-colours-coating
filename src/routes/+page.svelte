...
<svelte:head>
	<title
		>{data.settings?.companyName ?? siteConfig.seo.siteName} | {data.settings?.tagline ??
			siteConfig.seo.tagline}</title
	>
	...
	<meta
		property="og:title"
		content="{data.settings?.companyName ?? siteConfig.seo.siteName} - {data.settings?.tagline ??
