...
{#if waUrl}
  <a
    ...
    class="fixed bottom-6 right-6 z-50 flex items-center justify-center w-14 h-14 bg-[#25D366] hover:bg-[#20ba5a] text-white rounded-full shadow-[0_4px_20px_rgba(37,211,102,0.35)] transition-all hover:scale-105 active:scale-95 border border-white/10"
  >
