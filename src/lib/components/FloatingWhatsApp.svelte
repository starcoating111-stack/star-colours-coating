...
{#if waUrl}
  <a
    ...
    class="fixed bottom-6 right-6 z-50 flex items-center gap-2.5 bg-[#25D366] hover:bg-[#1fba59] text-white font-semibold text-sm px-4 py-3 rounded-full shadow-xl transition-all hover:scale-105 active:scale-95 group"
  >
