...
<section class="py-24 bg-zinc-950 px-6 border-t border-zinc-900 selection:bg-zinc-800 selection:text-white">
  <div class="max-w-4xl mx-auto space-y-16">
    ...
    <div class="text-center space-y-4">
      ...
      <h2 class="text-3xl sm:text-4xl font-bold text-white tracking-tight">Frequently Asked Questions</h2>
    </div>
    ...
    <div class="text-center">
      <a href="/faqs" class="text-xs font-semibold text-zinc-450 hover:text-white hover:underline transition-all">
